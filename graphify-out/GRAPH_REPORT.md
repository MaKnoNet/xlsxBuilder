...
## Corpus Check
- 49 files · ~24,182 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 525 nodes · 1476 edges · 43 communities (34 shown, 9 thin omitted)
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 542 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a0888c85`
...
Cohesion: 0.07
Nodes (28): Closeable, CloseableIterator, Comparator, Node, PriorityQueue, SortKey, Override, Override (+20 more)
...
Cohesion: 0.07
Nodes (21): Predicate, R, Serializable, String, Object, Column, ColumnGroup, ColumnType (+13 more)
...
## Knowledge Gaps
- **88 isolated node(s):** `String`, `String`, `String`, `Info`, `Override` (+83 more)
